...
main(void)
{
  ...
  12:	8c250513          	addi	a0,a0,-1854 # 8d0 <malloc+0xec>
  16:	00000097          	auipc	ra,0x0
  1a:	3c8080e7          	jalr	968(ra) # 3de <open>
  ...
  28:	3f2080e7          	jalr	1010(ra) # 416 <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3e8080e7          	jalr	1000(ra) # 416 <dup>

  for(;;){
    printf("init: starting sh\n");
  36:	00001917          	auipc	s2,0x1
  3a:	8a290913          	addi	s2,s2,-1886 # 8d8 <malloc+0xf4>
  3e:	854a                	mv	a0,s2
  40:	00000097          	auipc	ra,0x0
  44:	6e6080e7          	jalr	1766(ra) # 726 <printf>
    pid = fork();
  48:	00000097          	auipc	ra,0x0
  4c:	34e080e7          	jalr	846(ra) # 396 <fork>
  50:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  5e:	34c080e7          	jalr	844(ra) # 3a6 <wait>
      if(wpid == pid){
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x144>
  72:	00000097          	auipc	ra,0x0
  76:	6b4080e7          	jalr	1716(ra) # 726 <printf>
        exit(1);
  7a:	4505                	li	a0,1
  7c:	00000097          	auipc	ra,0x0
  80:	322080e7          	jalr	802(ra) # 39e <exit>
    mknod("console", CONSOLE, 0);
  84:	4601                	li	a2,0
  86:	4585                	li	a1,1
  88:	00001517          	auipc	a0,0x1
  8c:	84850513          	addi	a0,a0,-1976 # 8d0 <malloc+0xec>
  90:	00000097          	auipc	ra,0x0
  94:	356080e7          	jalr	854(ra) # 3e6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	addi	a0,a0,-1994 # 8d0 <malloc+0xec>
  a2:	00000097          	auipc	ra,0x0
  a6:	33c080e7          	jalr	828(ra) # 3de <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	addi	a0,a0,-1980 # 8f0 <malloc+0x10c>
  b4:	00000097          	auipc	ra,0x0
  b8:	672080e7          	jalr	1650(ra) # 726 <printf>
      exit(1);
  bc:	4505                	li	a0,1
  be:	00000097          	auipc	ra,0x0
  c2:	2e0080e7          	jalr	736(ra) # 39e <exit>
      exec("sh", argv);
  c6:	00001597          	auipc	a1,0x1
  ca:	f3a58593          	addi	a1,a1,-198 # 1000 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	83a50513          	addi	a0,a0,-1990 # 908 <malloc+0x124>
  d6:	00000097          	auipc	ra,0x0
  da:	300080e7          	jalr	768(ra) # 3d6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	addi	a0,a0,-1998 # 910 <malloc+0x12c>
...
_main()
{
 ...
 10e:	294080e7          	jalr	660(ra) # 39e <exit>
...
gets(char *buf, int max)
{
 ...
 204:	1b6080e7          	jalr	438(ra) # 3b6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 256:	18c080e7          	jalr	396(ra) # 3de <open>
  if(fd < 0)
 ...
 266:	194080e7          	jalr	404(ra) # 3f6 <fstat>
 26a:	892a                	mv	s2,a0
  close(fd);
 26c:	8526                	mv	a0,s1
 26e:	00000097          	auipc	ra,0x0
 272:	158080e7          	jalr	344(ra) # 3c6 <close>
  return r;
}
 276:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a8:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffefe0>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	3f2b8b93          	addi	s7,s7,1010 # 950 <digits>
 ...
 6a2:	2aa90913          	addi	s2,s2,682 # 948 <malloc+0x164>
        while(*s != 0){
...
free(void *ap)
{
 ...
 76a:	8aa7b783          	ld	a5,-1878(a5) # 1010 <freep>
...
malloc(uint nbytes)
{
 ...
 840:	7e478793          	addi	a5,a5,2020 # 1020 <base>
 ...
 86e:	7aa73323          	sd	a0,1958(a4) # 1010 <freep>
      return (void*)(p + 1);
